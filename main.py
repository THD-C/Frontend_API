...
from src.router import access, wallets, user, order, payments, currency, healthcheck, crypto_data, blog, statistics
...
app.include_router(statistics.statistics_router, prefix="/api/statistics")
